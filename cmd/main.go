...
import (
	...
	"github.com/zernico/postgresql-access-operator/internal/controller"
...
func main() {
	...
	mgr, err := ctrl.NewManager(ctrl.GetConfigOrDie(), ctrl.Options{
		...
		LeaderElectionID:       "98f1e7ed.zernico.de",
	...
	if err := (&controller.PostgreSQLReconciler{
		...
		setupLog.Error(err, "Failed to create controller", "controller", "PostgreSQL")
		os.Exit(1)
	}
	...
	if err := (&controller.PostgreSQLUserReconciler{
		...
		setupLog.Error(err, "Failed to create controller", "controller", "PostgreSQLUser")
		os.Exit(1)
	}
	if err := (&controller.PostgreSQLGrantReconciler{
		Client: mgr.GetClient(),
		Scheme: mgr.GetScheme(),
	}).SetupWithManager(mgr); err != nil {
		setupLog.Error(err, "Failed to create controller", "controller", "PostgreSQLGrant")
		os.Exit(1)
	}
